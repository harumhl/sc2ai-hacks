...
# 'sparse_agent_data' = 'sparse_agent_data'
...
class SparseAgent(base_agent.BaseAgent):
    def __init__(self):
        ...
        if os.path.isfile('sparse_agent_data'):
            self.qlearn.q_table = pd.read_pickle('sparse_agent_data')
            print("QLearning Table Loaded: Size=" + str(len(self.qlearn.q_table)))
    ...
    def step(self, obs):
        ...
        if obs.last():
            reward = obs.reward
            print("QLearning Table: Size=" + str(len(self.qlearn.q_table)))
            self.qlearn.learn(str(self.previous_state), self.previous_action, reward, 'terminal')

            self.qlearn.q_table.to_pickle('sparse_agent_data')
            self.previous_action = None
            self.previous_state = None
